"""
load_test.py — Skrip Pengujian Beban Server NgeChat
====================================================
Menjalankan N klien simulasi secara bersamaan.  Setiap klien:
  1. Registrasi (jika diperlukan) lalu login
  2. Masuk ke ruang pengujian menggunakan kode undangan
  3. Mengirimkan M pesan broadcast ke ruang tersebut
  4. Logout dan tutup koneksi

Metrik yang dikumpulkan:
  - Total pesan terkirim
  - Jumlah kegagalan koneksi / pengiriman pesan
  - Rata-rata latensi per pesan (waktu antara send dan menerima echo kembali)
  - Throughput keseluruhan (pesan/detik)
...
----------------
  ...
  2. Buat ruang pengujian di GUI atau jalankan skrip setup di bawah ini:
       python load_test.py --setup

  3. Jalankan pengujian:
       python load_test.py --clients 10 --messages 20 --code XXXXXXXX

  Ganti XXXXXXXX dengan kode undangan ruang pengujian.

Argumen CLI
-----------
  --host      HOST     Alamat server (default: 127.0.0.1)
  --port      PORT     Port server   (default: 9090)
  --clients   N        Jumlah klien simulasi (default: 10)
  --messages  M        Jumlah pesan per klien (default: 20)
  --code      CODE     Kode undangan ruang pengujian
  --delay     DETIK    Jeda antar pesan per klien dalam detik (default: 0.05)
  --setup              Buat akun admin + ruang pengujian, lalu tampilkan kode
"""
